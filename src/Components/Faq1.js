      ...
      <section className="join_form_section faq_section">
        <Container maxWidth="xl ">
          ...
          <Grid container className="">
            <Grid xs={12} sm={12} md={5} className="p_20  join_form_section_flex p-5">
              <img src={signup} alt="" className="img-fluid" />
            </Grid>



            <Grid xs={12} sm={12} md={7} className="p_20 p-5">
                    ...
                    <Accordion
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            Q: How do I participate in a BUFF GOOFY presale event?
                          </Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                          <Typography
                          ...
                          >
                            A: To participate in a BUFF GOOFY presale event, you
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            Q: What are the benefits of investing in a BUFF GOOFY
                            presale?
                          </Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                          <Typography className="restContent text-transparent bg-clip-text bg-gradient-to-br from-[#4361EE] to-[#4CC9F0]" sx={{ 
                            ...
                            A: Investing in BUFF GOOFY presale can provide benefits
                            such as getting BUFF GOOFY tokens at a discounted price,
                            participating in early access to the protocol,
                            whitelisting for hosting a node or becoming a
                            validator in BUFF GOOFY Blockchain and potentially
